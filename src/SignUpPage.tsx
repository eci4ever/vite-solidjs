import { Component, createSignal, onError } from "solid-js";
...
const SignUpPage: Component = () => {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    await signUp.email(
      ...
      {
        onSuccess: () => {
          navigate("/"); // SolidJS navigate lebih simple
        },
        onError: (error) => {
          console.error(error);
        },
            ...
            <form class="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div class="mt-1 relative">
                    ...
                    <input
                      ...
                      onInput={(e) =>
                        updateFormData("firstName", e.currentTarget.value)
                      }
                    />
                  </div>
                </div>
                <div>
                  ...
                  <div class="mt-1 relative">
                    ...
                    <input
                      ...
                      onInput={(e) =>
                        updateFormData("lastName", e.currentTarget.value)
                      }
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="mt-1">
                  <input
                    ...
                    onInput={(e) =>
                      updateFormData("company", e.currentTarget.value)
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div class="mt-1 relative">
                  ...
                  <input
                    ...
                    onInput={(e) =>
                      updateFormData("confirmPassword", e.currentTarget.value)
                    }
                  />
                  <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                    <button
              ...
              <div class="flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    updateFormData("agreeToTerms", e.currentTarget.checked)
                  }
                />
                <label
                  for="agreeToTerms"

...
const DashboardPage: Component = () => {
  ...
  console.log("session loading:", session().isPending);
  console.log("session error:", session().error);

  // Redirect ke sign in jika tidak ada session
      ...
      >
        <div class="p-6">
          ...
          <div class="mb-8">
            ...
            {/* Session Debug Info - boleh dibuang nanti */}
            <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div class="text-xs text-blue-700 space-y-1">
                <div>
                  <strong>User ID:</strong> {session().data?.user?.id || "N/A"}
                </div>
                <div>
                  <strong>Email:</strong> {session().data?.user?.email || "N/A"}
                </div>
                <div>
                  <strong>Name:</strong> {session().data?.user?.name || "N/A"}
                </div>
                <div>
